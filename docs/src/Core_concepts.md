...
- **`enumAsString`**: When `true`, stores enum values as their string name instead of an integer. Defaults to `false`. See [Enum Properties](Advanced_topics.md#enum-properties).
