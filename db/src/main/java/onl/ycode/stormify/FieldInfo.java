...
public class FieldInfo {
    ...
    FieldInfo(String name, String dbName, Class<?> type, Method getter, Method setter, String sequence, boolean autoIncrement, boolean primaryKey, boolean creatable, boolean updatable) {
        this.name = name;
        this.dbName = dbName;
        this.type = type;
        this.getter = getter;
        ...
        this.creatable = creatable && !autoIncrement;
    ...
    /**
     * Check if the field value is auto-generated by the database.
     *
