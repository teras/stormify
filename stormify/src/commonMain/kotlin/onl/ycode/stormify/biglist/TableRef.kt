 ...
 *
 * Obtain a `TableRef` via [PagedListBase.addTableRef] or
 * [PagedQueryBase.addTableRef]. The library guarantees that the
 ...
 * conditionally present. Note that in a stateless [PagedQueryBase],
